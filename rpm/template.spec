...
Name:           ros-rolling-fuse-graphs
Version:        1.0.1
Release:        2%{?dist}%{?release_suffix}
Summary:        ROS fuse_graphs package
...
%description
The fuse_graphs package provides some concrete implementations of the
fuse_core::Graph interface.
