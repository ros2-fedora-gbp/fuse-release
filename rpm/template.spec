...
Name:           ros-rolling-fuse-variables
Version:        1.0.1
Release:        2%{?dist}%{?release_suffix}
Summary:        ROS fuse_variables package
...
%description
The fuse_variables package provides a set of commonly used variable types, such
as 2D and 3D positions, \ orientations, velocities, and accelerations.
...
%changelog
* Tue Jun 20 2023 Stephen Williams <swilliams@locusrobotics.com> - 1.0.1-2
