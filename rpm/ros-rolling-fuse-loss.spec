...
Name:           ros-rolling-fuse-loss
Version:        1.0.1
Release:        2%{?dist}%{?release_suffix}
Summary:        ROS fuse_loss package
...
%description
The fuse_loss package provides a set of commonly used loss functions, such as
the basic ones provided by Ceres.
